...
class ConvNet(nn.Module):
    def __init__(self, input_dimensions: Tuple[int, int], num_actions):
        # game params
        self.board_x, self.board_y = input_dimensions
        ...
        self.conv1 = nn.Conv2d(2, num_channels, 3, stride=1, padding=1)
        ...
        self.fc1 = nn.Linear(num_channels*(self.board_x-4)*(self.board_y-4)+1, 1024)
    ...
    def forward(self, stack, s, legal_mask):
        ...
        return F.log_softmax(pi*legal_mask, dim=1)